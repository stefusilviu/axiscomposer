...
jQuery( function( $ ) {
	...
	var ac_custom_sidebars_actions = {
		...
		delete_sidebar: function( e ) {
			var widgets = $( e.currentTarget ).parents( '.widgets-holder-wrap:eq(0)' ), title = widgets.find( '.sidebar-name h2, .sidebar-name h3' ); // Since WP 4.4, Sidebar name is stored in h2 tag.
