			...
			apply_filters( 'axiscomposer_register_post_type_portfolio',
				array(
					'labels'              => array(
							...
							'insert_into_item'      => __( 'Insert into project', 'axiscomposer' ),
							'uploaded_to_this_item' => __( 'Uploaded to this project', 'axiscomposer' ),
							'filter_items_list'     => __( 'Filter Projects', 'axiscomposer' ),
							'items_list_navigation' => __( 'Projects navigation', 'axiscomposer' ),
							'items_list'            => __( 'Projects list', 'axiscomposer' ),
						),
