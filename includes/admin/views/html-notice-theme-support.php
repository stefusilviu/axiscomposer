...
<div id="message" class="updated axiscomposer-message ac-connect">
	<p><?php printf( __( '<strong>Your theme does not declare AxisComposer support</strong> &#8211; Please read our %sintegration%s guide or check out our %official themes%s which are designed specifically for use with WooCommerce.', 'axiscomposer' ), '<a href="' . esc_url( apply_filters( 'axiscomposer_docs_url', 'http://docs.axisthemes.com/document/third-party-custom-theme-compatibility/', 'theme-compatibility' ) ) . '">', '</a>', '<a href="' . esc_url( 'http://axisthemes.com/themes/' ) . '">', '</a>' ); ?></p>
	<p class="submit">
